        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div style={{ fontFamily: 'var(--font-body)', color: '#6B7A99', fontSize: '0.75rem' }}>
              {new Date(consultation.date).toLocaleDateString('en-PH', { year: 'numeric', month: 'long', day: 'numeric' })} Â· {consultation.doctorName}
            </div>
          </div>
        </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p style={{ fontFamily: 'var(--font-body)', color: 'rgba(255,255,255,0.7)', fontSize: '0.85rem' }}>
                  Patient ID: #{patient.id.slice(0, 8).toUpperCase()} Â· {patient.gender.charAt(0).toUpperCase() + patient.gender.slice(1)}
                  {patient.dateOfBirth ? ` Â· ${new Date().getFullYear() - new Date(patient.dateOfBirth).getFullYear()} yrs old` : ''}
                </p>
              </div>
            </div>
          </div>
                    ...
                    >
                      ...
                      <div className="flex items-center gap-1.5 mb-2">
                        ...
                        <span style={{ fontFamily: 'var(--font-body)', color: '#1B4FD8', fontSize: '0.75rem', fontWeight: 600 }}>
                          Clinic Review
                          {r.doctor_name ? ` Â· Visit with ${r.doctor_name}` : ''}
                        </span>
                      </div>
                      <div className="flex items-center gap-1.5 mb-2">
          ...
          >
            ...
            >
              ...
              <p className="text-center mb-3" style={{ fontFamily: 'var(--font-body)', color: 'rgba(255,255,255,0.9)', fontSize: '0.9rem', fontWeight: 600 }}>
                Valid ID â€” {patient.name}
              </p>
              <img src={patient.validIdUrl || 'https://placehold.co/400x250'} alt={`Valid ID â€” ${patient.name}`} className="w-full rounded-2xl"
